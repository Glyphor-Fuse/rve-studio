    ...
    <section className="relative min-h-screen flex flex-col justify-center px-8 md:px-24 pt-32 pb-24">
      <div className="relative z-10 max-w-7xl">
        ...
        <div className="flex flex-col md:flex-row items-end gap-12 mt-12">
          ...
          >
            <img 
              src="<span className="block"><img src="https://images.pexels.com/photos/30350434/pexels-photo-30350434.jpeg?auto=compress&cs=tinysrgb&h=650&w=940" alt="Portrait of a woman with unique face makeup and flowing hair in a dreamy setting." loading="lazy" /><a href="https://www.pexels.com/photo/elegant-woman-with-artistic-face-makeup-and-flowing-hair-30350434/" target="_blank" rel="noopener noreferrer" className="text-[10px] text-slate-400 block mt-0.5">Photo by Vika Glitter on Pexels</a></span>" 
              alt="Editorial 1"
